...
public class RegistrationController {
    ...
    @PostMapping
    public ResponseEntity<EntityModel<RegistrationResponse>> register(@RequestBody @Valid
                                                                      RegisterVehicleRequest req) {
        var reg = orchestrator.register(req.vehicleId(), req.ownerId(), req.agentId(), req.plate(),
                req.expiry());
